...
namespace Sirenix.OdinInspector.Demos
{
    ...
    public class BasicOdinEditorExampleWindow : OdinEditorWindow
    {
        ...
        [EnumPaging]
        [InfoBox(
            "Inherit from OdinEditorWindow instead of EditorWindow in order to create editor windows " +
            "like you would inspectors - by exposing members and using attributes.")]
